...
<p class="" data-start="3787" data-end="3876"><span style="font-size: 14pt;"><strong data-start="3787" data-end="3803">Explanation:</strong> The rows are reversed, so the last row becomes the first and vice versa.</span></p></div><br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>python</code>&nbsp;